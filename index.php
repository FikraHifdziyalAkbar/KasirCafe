...
<body>
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand" style="background-color: #000080;">
        <div class="container-lg">
            <a class="navbar-brand" style="color: #EEE8AA;" href="#"><i class="bi bi-cup-hot-fill"></i> CafeKita</a>
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" style="color: #EEE8AA;" href="#" role="button"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav flex-column nav-pills justify-content-end flex-grow-1">
                                    ...
                                    <li class="nav-item link-dark">
                                        <a class="nav-link" href="#"><i class="bi bi-cart2"></i> Order</a>
                                    </li>
                                    <li class="nav-item link-dark">
                                        <a class="nav-link" href="#"><i class="bi bi-person"></i> Customer</a>
                                    </li>
                                    <li class="nav-item link-dark">
                                        <a class="nav-link" href="#"><i class="bi bi-card-list"></i> Product</a>
                                    </li>
                                    <li class="nav-item link-dark">
                                        <a class="nav-link" href="#"><i class="bi bi-clipboard-data"></i> Report</a>
                                    </li>
